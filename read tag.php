...
<html>
	<head>
		...
		<title>Read Tag ID : E-Reseta</title>
	</head>
					...
					<tr>
						<td  bgcolor="black">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="black">
									<td align="left" class="lf">Doctor'sName</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr bgcolor="black">
								...
								<tr>
									<td width="113" align="left" class="lf">Patient's ID</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr bgcolor="black">
								...
								<tr>
									<td align="left" class="lf">Existing Medical Condition</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
							</table>
