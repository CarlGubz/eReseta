					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								<tr>
									<td align="left" class="lf">Hospital Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['Hospital Name'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">DEA</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['DEA'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Doctor's Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['Dr Name'];?></td>
								</tr>
								<tr>
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Prescription</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['prescription'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Medical Condition</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['medcon'];?></td>
								</tr>
							</table>
						</td>
					</tr>
